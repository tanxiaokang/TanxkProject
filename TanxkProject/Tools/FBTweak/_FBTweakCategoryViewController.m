...
NSString *const FBTweakFirstTimeWhenLaunched = @"FBTweakFirstTimeWhenLaunched";
...
- (void)viewDidLoad
{
    ...
    _footer = [[UILabel alloc] initWithFrame:CGRectMake(0, self.view.bounds.size.height - 40, self.view.frame.size.width, 36)];
    _footer.backgroundColor = [UIColor clearColor];
    _footer.textAlignment = NSTextAlignmentCenter;
    _footer.textColor = [UIColor colorWithRed:0.2 green:0.2 blue:0.2 alpha:1.0];
    _footer.text = [[NSUserDefaults standardUserDefaults] objectForKey:FBTweakFirstTimeWhenLaunched];
